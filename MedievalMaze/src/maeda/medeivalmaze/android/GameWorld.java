...
public class GameWorld {
	...
	public GameWorld(GameActivity activity, GameScene scene){
		...
		final Rectangle roof = new Rectangle(0, 0, activity.WORLDWIDTH, 2, vertexBufferObjectManager);
		final Rectangle left = new Rectangle(0, 0, 2, activity.height, vertexBufferObjectManager);
		final Rectangle right = new Rectangle(activity.WORLDWIDTH - 2, 0, 2, activity.height, vertexBufferObjectManager);
