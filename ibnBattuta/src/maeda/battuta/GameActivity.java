		...
		try {
			final TMXLoader tmxLoader = new TMXLoader(this.getAssets(), this.mEngine.getTextureManager(), TextureOptions.BILINEAR_PREMULTIPLYALPHA, this.getVertexBufferObjectManager(), new ITMXTilePropertiesListener() {
				...
				public void onTMXTileWithPropertiesCreated(final TMXTiledMap pTMXTiledMap, final TMXLayer pTMXLayer, final TMXTile pTMXTile, final TMXProperties<TMXTileProperty> pTMXTileProperties) {
					...
					//	GameActivity.this.mCactusCount++;
					//}
				}
			});
			this.mTMXTiledMap = tmxLoader.loadFromAsset("testmap1.tmx");
			this.runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Toast.makeText(GameActivity.this, "Cactus count in this TMXTiledMap: " + GameActivity.this.mCactusCount, Toast.LENGTH_LONG).show();
				}
			});
